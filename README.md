...
`groupMissingCount` provides an easy-to-use function that counts missing
values in each column of a dataframe grouped by a specified column. This
package simplifies the process of analyzing missing data by groups using
`dplyr` functions, making it ideal for data exploration and preliminary
data analysis.
